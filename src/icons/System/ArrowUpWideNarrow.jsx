...
export const ArrowUpWideNarrow = ({ size = 24, className = "", color = "currentColor" }) => {
  return (
    <svg 
    ...
    >
      ...
      <path d="M11 20h4" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </svg>
  );
};
