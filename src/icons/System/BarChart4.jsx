...
export const BarChart4 = ({ size = 24, className = "", color = "currentColor" }) => {
  return (
    <svg 
      ...
      color={color}
    >
      <path d="M13 17V9" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" />
      <path d="M18 17V5" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" />
