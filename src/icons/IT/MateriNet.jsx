...
export const MateriNet = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 7.84 12.00 a 4.16 4.16 0 1 0 8.32 0 a 4.16 4.16 0 1 0 -8.32 0" stroke-dasharray="2 3" />
