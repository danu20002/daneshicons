...
export const LiquidoScript = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 15.29 19.21 L 16.12 21.03" />
      <path d="M 10.87 19.85 L 10.59 21.83" />
      <path d="M 6.81 17.99 L 5.50 19.50" />
      <path d="M 4.39 14.23 L 2.47 14.80" />
      <path d="M 4.39 9.77 L 2.47 9.20" />
      <path d="M 6.81 6.01 L 5.50 4.50" />
      <path d="M 10.87 4.15 L 10.59 2.17" />
      <path d="M 15.29 4.79 L 16.12 2.97" />
