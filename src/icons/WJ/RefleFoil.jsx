...
export const RefleFoil = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 11.02 18.85 L 10.73 20.83" />
      ...
      <path d="M 11.02 5.15 L 10.73 3.17" />
