...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 3.38 12.00 a 8.62 2.587318864557892 0 1 0 17.25 0 a 8.62 2.587318864557892 0 1 0 -17.25 0"
      }
    ],
    [
      "path",
...
export const PolpoHike = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 3.38 12.00 a 8.62 2.587318864557892 0 1 0 17.25 0 a 8.62 2.587318864557892 0 1 0 -17.25 0" />
