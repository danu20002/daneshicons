...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 3.94 12.00 a 8.06 2.4172332500573246 0 1 0 16.11 0 a 8.06 2.4172332500573246 0 1 0 -16.11 0"
      }
    ],
    [
      "path",
...
export const BrakeKey = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 3.94 12.00 a 8.06 2.4172332500573246 0 1 0 16.11 0 a 8.06 2.4172332500573246 0 1 0 -16.11 0" />
