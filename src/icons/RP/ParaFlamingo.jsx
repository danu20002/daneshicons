...
export const ParaFlamingo = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
      ...
      {...rest}
    >
      <circle cx="6.00" cy="6.00" r="0.84" />
      <circle cx="6.00" cy="10.00" r="0.99" />
      <circle cx="6.00" cy="14.00" r="0.96" />
      <circle cx="6.00" cy="18.00" r="0.64" />
      <circle cx="10.00" cy="6.00" r="1.02" />
      ...
      <circle cx="18.00" cy="18.00" r="0.73" />
      {children}
    </svg>
  );
});

export default ParaFlamingo;
