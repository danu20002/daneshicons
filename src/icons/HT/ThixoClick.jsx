...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 7.59 12.00 a 4.41 4.41 0 1 1 8.82 0 a 4.41 4.41 0 1 1 -8.82 0"
      }
    ],
    [
      "path",
...
export const ThixoClick = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 7.59 12.00 a 4.41 4.41 0 1 1 8.82 0 a 4.41 4.41 0 1 1 -8.82 0" />
