...
export const BookAudio = ({ size = 24, className = "", color = "currentColor" }) => {
  return (
    <svg 
    ...
    >
      ...
      <path d="M16 8v3" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" />
      ...
      <path d="M8 8v3" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </svg>
  );
};
