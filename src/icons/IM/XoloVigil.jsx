...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 5.71 12.00 a 6.29 6.29 0 1 1 12.58 0 a 6.29 6.29 0 1 1 -12.58 0"
      }
    ],
    [
      "path",
...
export const XoloVigil = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 5.71 12.00 a 6.29 6.29 0 1 1 12.58 0 a 6.29 6.29 0 1 1 -12.58 0" />
