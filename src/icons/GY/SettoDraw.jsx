...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 2.75 12.00 a 9.25 2.7744394795037803 0 1 0 18.50 0 a 9.25 2.7744394795037803 0 1 0 -18.50 0"
      }
    ],
    [
      "path",
...
export const SettoDraw = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 2.75 12.00 a 9.25 2.7744394795037803 0 1 0 18.50 0 a 9.25 2.7744394795037803 0 1 0 -18.50 0" />
