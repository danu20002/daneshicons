...
export const AArrowUp = ({ size = 24, className = "", color = "currentColor" }) => {
  return (
    <svg 
      ...
      color={color}
    >
      <path d="m14 11 4-4 4 4" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" />
