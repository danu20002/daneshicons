...
export const BookmarkX = ({ size = 24, className = "", color = "currentColor" }) => {
  return (
    <svg 
      ...
      color={color}
    >
      <path d="m14.5 7.5-5 5" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" />
      ...
      <path d="m9.5 7.5 5 5" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </svg>
  );
};
