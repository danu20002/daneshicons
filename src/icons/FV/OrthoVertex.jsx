...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 5.84 12.00 a 6.16 6.16 0 1 0 12.33 0 a 6.16 6.16 0 1 0 -12.33 0"
      }
    ],
    [
      "path",
...
export const OrthoVertex = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 5.84 12.00 a 6.16 6.16 0 1 0 12.33 0 a 6.16 6.16 0 1 0 -12.33 0" />
