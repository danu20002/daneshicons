...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 2.46 12.00 a 9.54 2.8622871528379616 0 1 0 19.08 0 a 9.54 2.8622871528379616 0 1 0 -19.08 0"
      }
    ],
    [
      "path",
...
export const PhiloTwist = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 2.46 12.00 a 9.54 2.8622871528379616 0 1 0 19.08 0 a 9.54 2.8622871528379616 0 1 0 -19.08 0" />
