...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 5.90 12.00 a 6.10 6.10 0 1 1 12.19 0 a 6.10 6.10 0 1 1 -12.19 0"
      }
    ],
    [
      "path",
...
export const RenoGrunge = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 5.90 12.00 a 6.10 6.10 0 1 1 12.19 0 a 6.10 6.10 0 1 1 -12.19 0" />
