...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 2.70 12.00 a 9.30 2.7904107982758433 0 1 0 18.60 0 a 9.30 2.7904107982758433 0 1 0 -18.60 0"
      }
    ],
    [
      "path",
...
export const VirgultoSpell = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 2.70 12.00 a 9.30 2.7904107982758433 0 1 0 18.60 0 a 9.30 2.7904107982758433 0 1 0 -18.60 0" />
