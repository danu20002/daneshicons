...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 17.50 6.50 L 18.91 5.09"
      }
    ]
  ]
};

export const ResoOdd = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 17.50 17.50 L 18.91 18.91" />
      <path d="M 12.00 19.77 L 12.00 21.77" />
      <path d="M 6.50 17.50 L 5.09 18.91" />
      <path d="M 4.23 12.00 L 2.23 12.00" />
      <path d="M 6.50 6.50 L 5.09 5.09" />
      <path d="M 12.00 4.23 L 12.00 2.23" />
      <path d="M 17.50 6.50 L 18.91 5.09" />
      {children}
    </svg>
  );
});

export default ResoOdd;
