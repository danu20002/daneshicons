...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 17.83 8.25 L 19.51 7.17"
      }
    ]
  ]
};

export const VulgoStunt = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 17.83 15.75 L 19.51 16.83" />
      ...
      <path d="M 17.83 8.25 L 19.51 7.17" />
      {children}
    </svg>
  );
});

export default VulgoStunt;
