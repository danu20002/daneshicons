...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 17.86 8.24 L 19.54 7.16"
      }
    ]
  ]
};

export const ZonaHammer = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 17.86 15.76 L 19.54 16.84" />
      ...
      <path d="M 17.86 8.24 L 19.54 7.16" />
      {children}
    </svg>
  );
});

export default ZonaHammer;
