...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 2.77 12.00 a 9.23 2.768574897246435 0 1 0 18.46 0 a 9.23 2.768574897246435 0 1 0 -18.46 0"
      }
    ],
    [
      "path",
...
export const VerboPlasma = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 2.77 12.00 a 9.23 2.768574897246435 0 1 0 18.46 0 a 9.23 2.768574897246435 0 1 0 -18.46 0" />
