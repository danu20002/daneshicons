...
export const PulsoPeace = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 10.91 19.56 L 10.63 21.54" />
      ...
      <path d="M 10.91 4.44 L 10.63 2.46" />
