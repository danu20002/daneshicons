...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 6.21 12.00 a 5.79 5.79 0 1 1 11.58 0 a 5.79 5.79 0 1 1 -11.58 0"
      }
    ],
    [
      "path",
...
export const ObliqDeploy = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 6.21 12.00 a 5.79 5.79 0 1 1 11.58 0 a 5.79 5.79 0 1 1 -11.58 0" />
