...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 3.60 9.03 a 8.40 2.5208346982031693 0 1 0 16.81 0 a 8.40 2.5208346982031693 0 1 0 -16.81 0"
      }
    ],
    [
      "path",
      {
        "d": "M 3.60 14.97 a 8.40 2.5208346982031693 0 1 0 16.81 0 a 8.40 2.5208346982031693 0 1 0 -16.81 0"
      }
    ],
    [
      "path",
...
export const YachtViolin = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 3.60 9.03 a 8.40 2.5208346982031693 0 1 0 16.81 0 a 8.40 2.5208346982031693 0 1 0 -16.81 0" />
      <path d="M 3.60 14.97 a 8.40 2.5208346982031693 0 1 0 16.81 0 a 8.40 2.5208346982031693 0 1 0 -16.81 0" />
