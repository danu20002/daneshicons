...
export const iconData = {
  ...
  "nodes": [
    ...
    [
      "path",
      {
        "d": "M 5.28 12.00 a 6.72 6.72 0 1 1 13.43 0 a 6.72 6.72 0 1 1 -13.43 0"
      }
    ],
    [
      "path",
...
export const PulsoSupply = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <path d="M 5.28 12.00 a 6.72 6.72 0 1 1 13.43 0 a 6.72 6.72 0 1 1 -13.43 0" />
