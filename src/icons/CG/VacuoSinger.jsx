...
export const VacuoSinger = React.forwardRef(({ size = 24, className = "", color = "currentColor", strokeWidth = 2, children, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      ...
      <circle cx="6.00" cy="14.00" r="0.31" />
      ...
      <circle cx="18.00" cy="10.00" r="1.00" />
      <circle cx="18.00" cy="14.00" r="0.84" />
      <circle cx="18.00" cy="18.00" r="0.52" />
      {children}
    </svg>
  );
});

export default VacuoSinger;
